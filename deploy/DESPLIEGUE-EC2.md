...
```bash
sudo cp /var/www/dsj/deploy/php-fpm-dsj.conf /etc/php/8.4/fpm/pool.d/zz-dsj.conf
sudo systemctl restart php8.4-fpm

sudo cp /var/www/dsj/deploy/nginx/dsj.conf /etc/nginx/sites-available/dsj
...
En `deploy/nginx/dsj.conf`, reemplaza `server_name _;` por tu dominio.
